...
curl -o /docker_projects/everycharge/zero_downtime_deploy.py https://raw.githubusercontent.com/E-IT-Charge/E-IT-Charge-Api-Server/main/infraScript/zero_downtime_deploy.py
